...
import { ArgumentEmptyError, ArgumentError, ArgumentNullError, ArgumentRangeError, AssertionError, FormatError, getStackTrace, hideFromStackTrace, InvalidCastError, InvalidOperationError, NotImplementedError, NotSupportedError, NullReferenceError, ObjectDisposedError, PlatformNotSupportedError, SystemError, TimeoutError, Win32Error, } from "./mod.js";
...
dntShim.Deno.test("Win32Error", () => {
    ...
    }, Win32Error, `Win32 error ${code}. See ${code} for more information using ${win32Docs}.`);
...
dntShim.Deno.test("ArgumentError", () => {
    ...
    }, ArgumentError, "Argument myParam is invalid.");
...
dntShim.Deno.test("ArgumentEmptyError", () => {
    ...
    }, ArgumentEmptyError, "Argument myParam must not be null, undefined, or empty.");
    assert.equals(e.name, "ArgumentEmptyError");
    assert.exists(e.stack);
    assert.equals(e.parameterName, "myParam");
    assert.throws(() => {
        ArgumentEmptyError.throw(undefined, "myParam", "BAD!");
    }, ArgumentEmptyError, "BAD!");
    const e2 = assert.throws(() => {
